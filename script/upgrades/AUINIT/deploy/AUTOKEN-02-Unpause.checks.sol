...
contract AU02Checks is IAstonicUpgrade, GovernanceScript {
   ...
   */
    ...
    function run() public {
        ...
        assert(astonicToken.paused() == true);
        simulateProposal(_transactions, governanceFactory.governanceTimelock());
        assert(astonicToken.paused() == false);
    }
