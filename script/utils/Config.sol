...
library Config {
    ...
    struct Pool {
        ...
        /**
         * @dev The address of the first asset in the pool, typically will be the astonic stable.
     */
        address asset0;
        /**
    ...
    struct PartialReserve {
        ...
        */
        ...
        uint256 frozenPlanq; // not copied but should be set to 0
        ...
        */
        ...
        /**
         * @dev The address of the planq registry
     */
        address registryAddress;
        /**
         * @dev The % of Planq that can be spent per day by spenders (in fixidity format)
     */
        uint256 spendingRatioForPlanq;
        /**
     ...
     *      This is deprecated but should be set to the Broker for tokens created post Mc Astonic.
     */
   ...
   */
    ...
    /**
     * @notice Helper function to get the function selectors for the Planq stable constitution
   */
    function getPlanqStableConstitutionSelectors() internal pure returns (bytes4[] memory) {
        return
            Arrays.bytes4s(
    ...
    /**
     * @notice Helper function to get the thresholds for the Planq stable constitution
   */
    function getPlanqStableConstitutionThresholds() internal pure returns (uint256[] memory) {
